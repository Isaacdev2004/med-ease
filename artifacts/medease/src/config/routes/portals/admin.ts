...
export const adminRouteGroup: PortalRouteGroup = {
  ...
  routes: [
    ...
    ...createAdminFacilitiesRoutes('admin', {
      icon: Building,
      label: 'Facilities',
      order: 3,
    }),
    ...
    ...createAdminInventoryRoutes('admin', {
      icon: Package,
      label: 'Inventory',
      order: 8,
    }),
    ...createAdminProcurementRoutes('admin', {
      icon: ShoppingCart,
      label: 'Procurement',
      order: 9,
    }),
    ...createAdminWorkforceRoutes('admin', {
      icon: UserCog,
      label: 'Workforce',
      order: 10,
    }),
    ...createAdminFinanceRoutes('admin', {
      icon: Landmark,
      label: 'Finance',
      order: 11,
    }),
    ...createAdminQualityRoutes('admin', {
      icon: Shield,
      label: 'Quality',
      order: 12,
    }),
    ...createAdminPhmRoutes('admin', {
      icon: HeartPulse,
      label: 'Population Health',
      order: 13,
    }),
    ...createAdminCdssRoutes('admin', {
      icon: Brain,
      label: 'Clinical Decision Support',
      order: 14,
    }),
    ...createAdminInteropRoutes('admin', {
      icon: Network,
      label: 'Interoperability',
      order: 15,
    }),
    ...createAdminResearchRoutes('admin', {
      icon: Microscope,
      label: 'Clinical Research',
      order: 16,
    }),
    ...createAdminPublicHealthRoutes('admin', {
      icon: HeartHandshake,
      label: 'Public Health',
      order: 17,
    }),
    ...createAdminAiRoutes('admin', {
      icon: Sparkles,
      label: 'AI Intelligence',
      order: 18,
    }),
    ...createAdminExecutiveRoutes('admin', {
      icon: LayoutDashboard,
      label: 'Executive',
      order: 19,
    }),
    ...createAdminIamRoutes('admin', {
      icon: Lock,
      label: 'Identity & Security',
      order: 20,
    }),
    ...createAdminDocumentRoutes('admin', {
      icon: FileText,
      label: 'Documents',
      order: 21,
    }),
    ...createAdminWorkflowRoutes('admin', {
      icon: GitBranch,
      label: 'Workflows',
      order: 22,
    }),
    ...createAdminMessagingRoutes('admin', {
      icon: MessageSquare,
      label: 'Messaging',
      order: 23,
    }),
    ...createAdminApiPlatformRoutes('admin', {
      icon: Code2,
      label: 'API Platform',
      order: 24,
    }),
    ...createAdminReportingRoutes('admin', {
      icon: FileBarChart,
      label: 'Reporting',
      order: 25,
    }),
    ...createAdminPlatformRoutes('admin', {
      icon: Server,
