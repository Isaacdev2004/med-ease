...
export const facilityRouteGroup: PortalRouteGroup = {
  ...
  routes: [
    ...
    ...createFacilityInventoryRoutes('facility', { icon: Package, label: 'Inventory', order: 9 }),
    ...createFacilityProcurementRoutes('facility', { icon: ShoppingCart, label: 'Procurement', order: 10 }),
    ...createFacilityFinanceRoutes('facility', { icon: Landmark, label: 'Finance', order: 11 }),
    ...createFacilityQualityRoutes('facility', { icon: Shield, label: 'Quality', order: 12 }),
    ...createFacilityPhmRoutes('facility', { icon: HeartPulse, label: 'Population Health', order: 13 }),
    ...createFacilityCdssRoutes('facility', { icon: Brain, label: 'Clinical Decision Support', order: 14 }),
    ...createFacilityInteropRoutes('facility', { icon: Network, label: 'Interoperability', order: 15 }),
    ...createFacilityResearchRoutes('facility', { icon: Microscope, label: 'Clinical Research', order: 16 }),
    ...createFacilityPublicHealthRoutes('facility', { icon: HeartHandshake, label: 'Public Health', order: 17 }),
    ...createFacilityAiRoutes('facility', { icon: Sparkles, label: 'AI Intelligence', order: 18 }),
    ...createFacilityExecutiveRoutes('facility', { icon: LayoutDashboard, label: 'Executive', order: 19 }),
    ...createFacilityIamRoutes('facility', { icon: Lock, label: 'Identity & Security', order: 20 }),
    ...createFacilityDocumentRoutes('facility', { icon: FileText, label: 'Documents', order: 21 }),
    ...createFacilityWorkflowRoutes('facility', { icon: GitBranch, label: 'Workflows', order: 22 }),
    ...createFacilityMessagingRoutes('facility', { icon: MessageSquare, label: 'Messaging', order: 23 }),
    ...createFacilityReportingRoutes('facility', { icon: FileBarChart, label: 'Reports', order: 24 }),
    ...createFacilityApiPlatformRoutes('facility', { icon: Code2, label: 'Developer', order: 25 }),
