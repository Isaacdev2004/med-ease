...
class IamRepository implements IamRepositoryContract {
  ...
  async getUsers(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetUsersUrl(), {
  ...
  async getTenants(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetTenantsUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getRoles(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetRolesUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getPermissions(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetPermissionsUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getPolicies(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetPoliciesUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getSessions(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetSessionsUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getLoginHistory(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetLoginHistoryUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getMfaDevices(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetMfaDevicesUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getOauthClients(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetOauthClientsUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getApiKeys(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetApiKeysUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getConsents(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetConsentsUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getDelegations(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetDelegationsUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getProxyAccess(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetProxyAccessUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getBreakGlass(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetBreakGlassUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getAuditEvents(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetAuditEventsUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async getRiskScores(filters?: IamFilters) {
    const dto = await this.transport.get(getIamControllerGetRiskScoresUrl(), {
      query: filtersToQuery(filters),
    });
  ...
  async createUser(input: CreateUserInput) {
    const dto = await this.transport.post(getIamControllerCreateUserUrl(), {
      body: input,
    });
    return mapUserDto(dto);
  }
  ...
  async inviteUser(input: InviteUserInput) {
    const dto = await this.transport.post(getIamControllerInviteUserUrl(), {
      body: input,
    });
    return mapUserDto(dto);
  }
  ...
  async lockAccount(userId: string) {
    const dto = await this.transport.post(
      getIamControllerLockAccountUrl(userId),
    );
    return mapUserDto(dto);
  }
  ...
  async unlockAccount(userId: string) {
    const dto = await this.transport.post(
      getIamControllerUnlockAccountUrl(userId),
    );
    return mapUserDto(dto);
  }

  async assignRole(input: AssignRoleInput) {
    const dto = await this.transport.post(getIamControllerAssignRoleUrl(), {
      body: input,
    });
    return mapUserDto(dto);
  }
  ...
  async removeRole(input: AssignRoleInput) {
    const dto = await this.transport.post(getIamControllerRemoveRoleUrl(), {
      body: input,
    });
    return mapUserDto(dto);
  }
  ...
  async createPolicy(input: CreatePolicyInput) {
    const dto = await this.transport.post(getIamControllerCreatePolicyUrl(), {
      body: input,
    });
  ...
  async enableMfa(userId: string) {
    const dto = await this.transport.post(getIamControllerEnableMfaUrl(), {
      body: { userId },
    });
    return mapUserDto(dto);
  }
  ...
  async disableMfa(userId: string) {
    const dto = await this.transport.post(getIamControllerDisableMfaUrl(), {
      body: { userId },
    });
    return mapUserDto(dto);
  }
  ...
  async revokeSession(input: RevokeSessionInput) {
    const dto = await this.transport.post(
      getIamControllerRevokeSessionUrl(input.sessionId),
    );
  ...
  async rotateApiKey(keyId: string) {
    const dto = await this.transport.post(getIamControllerRotateApiKeyUrl(), {
      body: { keyId },
    });
  ...
  async grantConsent(input: GrantConsentInput) {
    const dto = await this.transport.post(getIamControllerGrantConsentUrl(), {
      body: input,
    });
  ...
  async revokeConsent(consentId: string) {
    const dto = await this.transport.post(
      getIamControllerRevokeConsentUrl(consentId),
    );
    return mapConsentDto(dto);
  }

  async delegateAccess(input: DelegateAccessInput) {
    const dto = await this.transport.post(getIamControllerDelegateAccessUrl(), {
      body: input,
    });
  ...
  async endBreakGlass(input: EndBreakGlassInput) {
    const dto = await this.transport.post(
      getIamControllerEndBreakGlassUrl(input.eventId),
    );
    return mapBreakGlassDto(dto);
  }
  ...
  async exportData(format: 'csv' | 'pdf' | 'xlsx') {
    const dto = await this.transport.post(getIamControllerExportDataUrl(), {
      body: { format },
    });
  ...
  async getFavorites(userId: string) {
    const dto = await this.transport.get(getIamControllerGetFavoritesUrl(), {
      query: { userId },
    });
  ...
  async share(input: ShareIamInput) {
    const dto = await this.transport.post(getIamControllerShareUrl(), {
      body: input,
    });
