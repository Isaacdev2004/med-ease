export type PhmNotificationType = 'care_gap_alert' | 'high_risk_patient' | 'campaign_scheduled' | 'registry_update';

export function buildPhmNotification(type: PhmNotificationType, context: Record<string, string>) {
