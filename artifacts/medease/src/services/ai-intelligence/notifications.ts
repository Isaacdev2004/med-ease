...
export function formatAiAlertNotification(alert: AiAlert): { title: string; body: string; severity: AiAlert['severity'] } {
  return {
    title: alert.title,
    body: alert.message,
...
export function groupAlertsByType(alerts: AiAlert[]): Record<string, AiAlert[]> {
