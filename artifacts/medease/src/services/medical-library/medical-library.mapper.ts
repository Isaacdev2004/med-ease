...
export const MOCK_MEDICATIONS: MedicationRecord[] = [
  baseMedication({
    ...
    searchCount: 980,
    description:
      'Présentation : boîte de comprimés. Antalgique et antipyrétique pour douleurs légères à modérées et fièvre.',
    activeIngredients: ['Paracétamol 500 mg'],
    indications: [
      'Céphalées',
      'Fièvre',
    ...
    precautions: [
      'Surveiller la fonction hépatique en usage chronique',
      'Vérifier la dose totale journalière toutes sources confondues',
    ],
    sideEffects: ['Rares : réactions cutanées', 'Surdosage : atteinte hépatique'],
    administration: ['Prendre avec de l’eau', 'Ne pas dépasser la dose recommandée'],
    storage: 'Conserver à moins de 25°C, à l’abri de l’humidité.',
    patientInformation:
      'Ne pas dépasser 3 g/jour chez l’adulte sans avis médical. Consultez la notice.',
    professionalInformation:
      'Maximum 4 g/jour chez l’adulte ; adapter en cas d’insuffisance hépatique.',
    dosages: [
      {
        population: 'adult',
    ...
    interactions: [
      {
        ...
        severity: 'moderate',
        description:
          'Peut potentialiser l’effet anticoagulant en usage prolongé.',
      },
    ],
