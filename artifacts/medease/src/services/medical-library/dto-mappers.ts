...
export function medicationFiltersToQuery(
  ...
  return {
    ...
    // Only send true flags — Nest `@Type(() => Boolean)` treats "false" as true.
    overTheCounter: filters.overTheCounter || undefined,
    route: filters.route,
    manufacturer: filters.manufacturer,
    pregnancySafety: filters.pregnancySafety,
    pediatric: filters.pediatric || undefined,
    geriatric: filters.geriatric || undefined,
    controlledSubstance: filters.controlledSubstance || undefined,
