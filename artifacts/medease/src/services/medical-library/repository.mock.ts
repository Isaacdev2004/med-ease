...
class MedicalLibraryMockRepository {
  async search(
    filters: MedicationFilters = {},
  ...
  async getPopularMedications(): Promise<string[]> {
...
export const medicalLibraryMockRepository = new MedicalLibraryMockRepository();
