...
export const LAB_TEST_CATALOG: LabTestDefinition[] = [
  ...
  },
  {
    ...
    specimenType: 'Whole blood',
    tubeType: 'EDTA Lavender',
    collectionInstructions: 'Mix gently after collection.',
    normalRange: '4.5–11.0',
    criticalRange: '<2 or >30',
  ...
  },
  {
    ...
    name: 'Platelets',
    category: 'hematology',
    description: 'Platelet count for clotting assessment.',
    specimenType: 'Whole blood',
    tubeType: 'EDTA Lavender',
    collectionInstructions: 'Avoid clots.',
    normalRange: '150–400',
  ...
  },
  {
    ...
    preparation: 'Fast 8–12 hours.',
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'Fasting required.',
    normalRange: '70–100',
    criticalRange: '<40 or >400',
  ...
  },
  {
    ...
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'No special prep.',
    normalRange: '0.7–1.3',
    criticalRange: '>5',
  ...
  },
  {
    ...
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'Calculated from creatinine.',
    normalRange: '>60',
    criticalRange: '<15',
  ...
  },
  {
    ...
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'Avoid hemolysis.',
    normalRange: '7–56',
    criticalRange: '>1000',
  ...
  },
  {
    ...
    name: 'AST',
    category: 'biochemistry',
    description: 'Liver/cardiac enzyme.',
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'Avoid hemolysis.',
    normalRange: '10–40',
  ...
  },
  {
    ...
    preparation: 'Fast 9–12 hours preferred.',
    specimenType: 'Serum',
    tubeType: 'Gold SST',
  ...
  },
  {
    ...
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'Process promptly.',
    normalRange: '3.5–5.0',
    criticalRange: '<2.5 or >6.5',
  ...
  },
  {
    ...
    specimenType: 'Plasma',
    tubeType: 'Blue Citrate',
    collectionInstructions: 'Fill tube completely.',
    normalRange: '11–13.5',
  ...
  },
  {
    ...
    specimenType: 'Urine',
    tubeType: 'Sterile cup',
    collectionInstructions: 'Clean-catch midstream.',
    normalRange: 'Normal',
  ...
  },
  {
    ...
    name: 'COVID-19 PCR',
    category: 'covid',
    description: 'SARS-CoV-2 nucleic acid detection.',
    specimenType: 'Nasopharyngeal swab',
    tubeType: 'VTM',
    collectionInstructions: 'Collect per protocol.',
  ...
  },
  {
    ...
    name: 'Beta hCG',
    category: 'pregnancy',
    description: 'Pregnancy hormone quantification.',
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'No fasting required.',
  ...
  },
  {
    ...
    description: 'Aerobic/anaerobic blood culture.',
    specimenType: 'Whole blood',
    tubeType: 'Culture bottles',
    collectionInstructions: 'Sterile technique required.',
  ...
  },
  {
    id: 't-hiv',
    loincCode: '75622-1',
    name: 'HIV Antibody/Antigen',
    category: 'immunology',
    description: 'HIV screening test.',
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'Pre-test counseling documented.',
  ...
  },
  {
    ...
    tubeType: 'EDTA Lavender',
    collectionInstructions: 'Process within 4 hours.',
    normalRange: '<100',
    criticalRange: '>900',
  ...
  },
  {
    ...
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'STAT for chest pain.',
    normalRange: '<0.04',
    criticalRange: '>0.4',
  ...
  },
  {
    ...
    specimenType: 'Serum',
    tubeType: 'Gold SST',
    collectionInstructions: 'Protect from light.',
    normalRange: '30–100',
  ...
  },
  {
    ...
    tubeType: 'Formalin container',
    collectionInstructions: 'Label per specimen site.',
    normalRange: 'N/A',
    referenceRange: 'See report',
    units: '',
    turnaroundHours: 168,
  ...
  },
  {
    id: 't-gen',
    loincCode: '48018-6',
    name: 'BRCA1/BRCA2 Panel',
    category: 'genetics',
    description: 'Hereditary cancer gene panel.',
    specimenType: 'Whole blood',
    tubeType: 'EDTA Lavender',
    collectionInstructions: 'Genetic counseling required.',
    normalRange: 'N/A',
    referenceRange: 'See report',
    units: '',
    turnaroundHours: 336,
  ...
  },
  {
    ...
    category: 'toxicology',
    description: 'Comprehensive toxicology screen.',
    specimenType: 'Urine',
    tubeType: 'Sterile cup',
    collectionInstructions: 'Chain of custody if forensic.',
  ...
  },
  {
    ...
    name: 'ABO/Rh Typing',
    category: 'blood_bank',
    description: 'Blood type determination.',
    specimenType: 'Whole blood',
    tubeType: 'EDTA Lavender',
    collectionInstructions: 'Two samples if transfusion.',
    normalRange: 'N/A',
    referenceRange: 'See report',
    units: '',
    turnaroundHours: 2,
...
export function computeResultFlag(
  ...
  const [lowStr, highStr] = test.normalRange
    .split('–')
  ...
  if (test.criticalRange) {
    ...
    for (const part of critParts) {
      if (part.startsWith('<') && numericValue < parseFloat(part.slice(1)))
        return 'critical_low';
      if (part.startsWith('>') && numericValue > parseFloat(part.slice(1)))
        return 'critical_high';
    }
  }
  if (!Number.isNaN(low) && numericValue < low)
    return numericValue < low * 0.7 ? 'critical_low' : 'low';
  if (!Number.isNaN(high) && numericValue > high)
    return numericValue > high * 1.5 ? 'critical_high' : 'high';
  return 'normal';
}
