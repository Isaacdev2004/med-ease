...
export function calculateLineTotal(item: Omit<InvoiceLineItem, 'id' | 'total'>) {
  return item.quantity * item.unitPrice;
}

export function calculateInvoiceTotals(lineItems: InvoiceLineItem[], discountPercent = 0, taxRate = 0.1) {
