...
export function Placeholder({ icon: Icon, title, description, children, className, ...props }: PlaceholderProps) {
  return (
    <div 
      className={cn(
    ...
    >
      <div className="relative z-10 flex flex-col items-center justify-center">
        {Icon && <Icon className="mb-4 h-10 w-10 text-muted-foreground/50" aria-hidden="true" />}
