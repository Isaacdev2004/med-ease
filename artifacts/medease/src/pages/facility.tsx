import { Building2, Users, Network, BarChart3, Settings, AlertTriangle, LayoutDashboard } from "lucide-react"
...
const facilityNav = [
  { icon: Building2, label: "Overview", href: "/facility" },
  { icon: Network, label: "Resource & Beds", href: "/facility/resources" },
  { icon: Users, label: "Staff Roster", href: "/facility/staff" },
  { icon: BarChart3, label: "Analytics", href: "/facility/analytics" },
  { icon: Settings, label: "Operations", href: "/facility/operations" },
]

export default function FacilityPortal() {
  return (
    <DashboardShell sidebarItems={facilityNav} roleName="Facility Admin" userName="Robert Vance">
