...
const ADMIN_TABS: Tab[] = [
  ...
  {
    segment: 'model-registry',
    label: 'Model Registry',
    path: 'model-registry',
  },
  {
    segment: 'model-monitoring',
...
export function AiIntelligenceTabs({
  basePath: _basePath,
  variant = 'professional',
}: AiIntelligenceTabsProps) {
...
export function getAiSectionFromPath(
  pathname: string,
