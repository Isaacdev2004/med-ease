...
export { ApiPlatformTabs, getApiPlatformSectionFromPath } from '@/features/api-platform/components/ApiPlatformTabs';
...
export { createProfessionalApiPlatformRoutes, createFacilityApiPlatformRoutes, createAdminApiPlatformRoutes } from '@/features/api-platform/routes';
