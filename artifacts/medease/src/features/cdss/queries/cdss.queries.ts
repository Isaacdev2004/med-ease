...
export const cdssQueries = {
  ...
  alerts: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.alerts(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getAlerts(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  recommendations: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.recommendations(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getRecommendations(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  guidelines: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.guidelines(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getGuidelines(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  orderSets: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.orderSets(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getOrderSets(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  pathways: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.pathways(filters as Record<string, unknown> | undefined),
  ...
  diagnostics: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.diagnostics(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getDiagnostics(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  drugSafety: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.drugSafety(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getDrugSafety(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  preventive: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.preventive(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getPreventiveCare(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  rules: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.rules(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getRules(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  protocols: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.protocols(filters as Record<string, unknown> | undefined),
    queryFn: () => cdssService.getProtocols(filters),
    staleTime: CACHE_TIMES.patientList,
  }),
  evidence: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.evidence(filters as Record<string, unknown> | undefined),
  ...
  audit: (filters?: CdssFilters) => ({
    queryKey: queryKeys.cdss.audit(filters as Record<string, unknown> | undefined),
