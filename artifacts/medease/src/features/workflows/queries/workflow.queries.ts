...
export const workflowQueries = {
  ...
  instances: (filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.instances(
      filters as Record<string, unknown> | undefined,
    ),
  ...
  tasks: (filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.tasks(
      filters as Record<string, unknown> | undefined,
    ),
  ...
  rules: (filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.rules(
      filters as Record<string, unknown> | undefined,
    ),
  ...
  jobs: (filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.jobs(
      filters as Record<string, unknown> | undefined,
    ),
  ...
  slas: (filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.slas(
      filters as Record<string, unknown> | undefined,
    ),
  ...
  escalations: (filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.escalations(
      filters as Record<string, unknown> | undefined,
    ),
  ...
  triggers: (filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.triggers(
      filters as Record<string, unknown> | undefined,
    ),
  ...
  audits: (filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.audits(
      filters as Record<string, unknown> | undefined,
    ),
  ...
  search: (query: string, filters?: WorkflowFilters) => ({
    queryKey: queryKeys.workflows.search(
      query,
      filters as Record<string, unknown> | undefined,
    ),
