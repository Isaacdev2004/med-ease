...
export { createPatientMedicationsRoutes, createProfessionalMedicationRoutes, createPharmacyMedicationRoutes, createFacilityMedicationRoutes, createAdminMedicationRoutes } from '@/features/medications/routes';
