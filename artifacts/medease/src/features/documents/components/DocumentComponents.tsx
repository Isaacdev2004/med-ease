  ...
  return (
    <Card>
      ...
      <CardContent className="text-sm space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          {document.type.toUpperCase()} · {formatFileSize(document.sizeBytes)}
        </p>
    ...
    <Card>
      <CardContent className="pt-4 flex items-center gap-3 text-sm">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Full-text search across documents and content index
          </p>
        </div>
      </CardContent>
    </Card>
  ...
  return (
    <Card>
      <CardContent className="pt-4 text-sm space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Signed {format(new Date(signature.signedAt), 'MMM d, yyyy')}
        </p>
      </CardContent>
    </Card>
  );
  ...
  return (
    <Card>
      <CardContent className="pt-4 text-sm space-y-2">
        <div className="flex justify-between gap-2">
          <span className="font-medium flex items-center gap-1">
            <Lock className="h-4 w-4" /> {hold.name}
          </span>
...
export function RecordsDashboard({ records }: { records: RecordItem[] }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">Records Management</CardTitle>
      </CardHeader>
...
export function DocumentAnalyticsPanel({
  analytics,
}: {
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {[
          ...
          { label: 'OCR Success', value: `${analytics.ocrSuccessRate}%` },
          {
            ...
            value: `${analytics.signatureCompletionRate}%`,
          },
          {
            label: 'Retention Compliance',
            value: `${analytics.retentionComplianceRate}%`,
          },
          {
      ...
      <BarChartPanel
        ...
        data={analytics.storageByModule}
      />
    </div>
  );
}
  ...
  return (
    <Card>
      <CardContent className="pt-4 text-sm space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          {policy.documentCount} documents
        </p>
      </CardContent>
    </Card>
  );
