...
function resolveSegment(location: string): Segment {
  ...
  if (location.includes('/immunization-registry'))
    return 'immunization-registry';
  if (location.includes('/maternal-child-health'))
  ...
  if (location.includes('/public-health-analytics'))
    return 'public-health-analytics';
  if (location.includes('/community-health-dashboard'))
    return 'community-health-dashboard';
