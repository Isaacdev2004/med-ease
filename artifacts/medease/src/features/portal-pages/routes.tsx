...
export interface PortalUtilityRouteOptions extends Partial<
  Omit<RouteDefinition, 'path' | 'lazy'>
> {
  breadcrumb?: string;
}
...
const admissionsPage = () =>
  import('@/features/portal-pages/pages/AdmissionsPage');
const transfersPage = () =>
  import('@/features/portal-pages/pages/TransfersPage');
const consultationsPage = () =>
  import('@/features/portal-pages/pages/ConsultationsPage');
const clinicalTasksPage = () =>
  import('@/features/portal-pages/pages/ClinicalTasksPage');
const analyticsPage = () =>
  import('@/features/portal-pages/pages/AnalyticsPage');
const bedManagementPage = () =>
  import('@/features/portal-pages/pages/BedManagementPage');
const capacityPage = () => import('@/features/portal-pages/pages/CapacityPage');
const resourcesPage = () =>
  import('@/features/portal-pages/pages/ResourcesPage');
const patientsListPage = () =>
  import('@/features/portal-pages/pages/PatientsListPage');
const healthcareProfessionalsPage = () =>
  import('@/features/portal-pages/pages/HealthcareProfessionalsPage');
const medicationRequestsPage = () =>
  import('@/features/portal-pages/pages/MedicationRequestsPage');
const emergencyProfilePage = () =>
  import('@/features/portal-pages/pages/EmergencyProfilePage');
const vaccinationsPage = () =>
  import('@/features/portal-pages/pages/VaccinationsPage');
const transportVehiclesPage = () =>
  import('@/features/portal-pages/pages/TransportVehiclesPage');
const transportDriversPage = () =>
  import('@/features/portal-pages/pages/TransportDriversPage');
const transportSchedulesPage = () =>
  import('@/features/portal-pages/pages/TransportSchedulesPage');
const transportHistoryPage = () =>
  import('@/features/portal-pages/pages/TransportHistoryPage');
const transportFacilitiesPage = () =>
  import('@/features/portal-pages/pages/TransportFacilitiesPage');
const medicalRecordsPage = () =>
  import('@/features/portal-pages/pages/MedicalRecordsPage');
const messagesPage = () => import('@/features/portal-pages/pages/MessagesPage');
const patientDocumentsPage = () =>
  import('@/features/portal-pages/pages/PatientDocumentsPage');
const reportsPage = () => import('@/features/portal-pages/pages/ReportsPage');
const adminSecurityPage = () =>
  import('@/features/iam/pages/AdminSecurityPage');
...
export function createAdminSecurityAliasRoutes(
  analyticsPrefix: string,
): RouteDefinition[] {
  return [
...
export function createAdminPlatformAliasRoutes(
  analyticsPrefix: string,
): RouteDefinition[] {
  return [
...
export function createFacilityPortalUtilityRoutes(
  analyticsPrefix: string,
): RouteDefinition[] {
  return [
...
export function createProfessionalPortalUtilityRoutes(
  analyticsPrefix: string,
): RouteDefinition[] {
  return [
...
export function createAdminPortalUtilityRoutes(
  analyticsPrefix: string,
): RouteDefinition[] {
  return [
...
export function createPharmacyPortalUtilityRoutes(
  analyticsPrefix: string,
): RouteDefinition[] {
  return [
...
export function createPatientPortalUtilityRoutes(
  analyticsPrefix: string,
): RouteDefinition[] {
  return [
...
export function createTransportPortalUtilityRoutes(
  analyticsPrefix: string,
): RouteDefinition[] {
  return [
