...
export const MOCK_MEDICATION_REQUESTS: MedicationRequestRow[] = [
  {
    ...
    patient: 'Maria Santos',
    medication: 'Heparin',
    dosage: '5000 units IV',
    requestedAt: '2026-07-15 08:45',
    status: 'pending',
  },
  {
    id: 'mr2',
...
export const MOCK_TRANSPORT_SCHEDULES: TransportScheduleRow[] = [
  ...
  },
  {
    id: 'ts3',
    patient: 'David Cohen',
    pickup: 'Heart Institute',
    destination: 'Central Hospital',
    scheduledAt: '2026-07-14 20:15',
    status: 'completed',
  },
];
...
export const MOCK_TRANSPORT_HISTORY: TransportHistoryRow[] = [
  ...
  },
  {
    id: 'th2',
    patient: 'Elena Rodriguez',
    route: 'Pediatrics → Imaging',
    completedAt: '2026-07-13 15:20',
    duration: '28 min',
    outcome: 'on-time',
  },
  {
    id: 'th3',
    patient: 'James Okafor',
    route: 'Clinic → Central Hospital',
    completedAt: '2026-07-12 09:10',
    duration: '55 min',
    outcome: 'delayed',
  },
];
