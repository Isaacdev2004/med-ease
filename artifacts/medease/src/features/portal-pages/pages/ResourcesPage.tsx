...
const initialResources = [
  {
    id: 'r1',
    primary: 'Portable ventilators',
    secondary: 'Respiratory therapy',
    badge: '8 available',
    count: 8,
  },
  {
    id: 'r2',
    primary: 'Infusion pumps',
    secondary: 'Med-Surg supply',
    badge: '24 available',
    count: 24,
  },
  {
    ...
    <PageShell
      ...
      primaryAction={
        <PortalActionButton
          ...
          successTitle="Resource request submitted"
        />
      }
    >
      <PortalMetricsGrid
      ...
      <SectionHeader
        ...
        description="Track availability across departments."
      />
      ...
      <PortalListCard
        ...
        items={[
          {
            id: 'a1',
            primary: 'Ventilator → ICU-3-02',
            secondary: 'Allocated 09:15 by Nurse Kim',
            badge: 'active',
          },
          {
            id: 'a2',
            primary: 'Wheelchair → Med-Surg 2B',
            secondary: 'Returned 08:40',
            badge: 'returned',
          },
        ]}
      />
