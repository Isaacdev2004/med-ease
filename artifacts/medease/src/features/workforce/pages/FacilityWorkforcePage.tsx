...
type Segment = 'workforce' | 'staff' | 'scheduling' | 'attendance' | 'leave' | 'training';
...
export default function FacilityWorkforcePage() {
  ...
  return <WorkforceShell basePath={resolveModuleBasePath(location, segment)} variant="facility" title={TITLES[segment]} facilityId="fac-001" />;
}
