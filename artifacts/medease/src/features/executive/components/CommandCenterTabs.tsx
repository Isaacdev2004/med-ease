...
const ADMIN_TABS: Tab[] = [
  ...
  {
    segment: 'enterprise-dashboard',
    label: 'Enterprise Dashboard',
    path: 'enterprise-dashboard',
  },
  {
    segment: 'enterprise-kpis',
...
export function getExecutiveSectionFromPath(
  pathname: string,
  ...
  if (pathname.includes('/strategic-initiatives'))
  ...
  if (
    ...
    !pathname.includes('/capacity-planning')
  )
    return 'capacity';
  if (
    variant === 'admin' &&
    pathname.includes('/executive') &&
    !pathname.includes('/executive-analytics') &&
    !pathname.includes('/executive-forecasting') &&
    !pathname.includes('/executive-scorecards')
  )
    return 'hub';
  return 'dashboard';
}
