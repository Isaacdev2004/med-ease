...
import {
  ProcurementTabs,
  getProcurementSectionFromPath,
} from '@/features/procurement/components/ProcurementTabs';
...
export function ProcurementShell({
  ...
  if (!perms.canView) {
    return (
      <PageShell title={title}>
        <EmptyState
          title="Access denied"
          description="You do not have permission to view procurement."
        />
      </PageShell>
    );
  }
  ...
  return (
    <PageShell
      title={title}
      subtitle="Enterprise procurement, purchasing, supply chain, approvals, contracts, and supplier management."
    >
