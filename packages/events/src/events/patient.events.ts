...
export type PatientEventTypeName = (typeof PatientEventType)[keyof typeof PatientEventType];
...
export const PatientEvents = {
  patientRegistered: (payload: PatientResourcePayload, context?: DomainEventContext) =>
    patientEvent(PatientEventType.PatientRegistered, payload, context),

  patientUpdated: (payload: PatientResourcePayload, context?: DomainEventContext) =>
    patientEvent(PatientEventType.PatientUpdated, payload, context),

  patientArchived: (payload: PatientResourcePayload, context?: DomainEventContext) =>
    patientEvent(PatientEventType.PatientArchived, payload, context),

  patientRestored: (payload: PatientResourcePayload, context?: DomainEventContext) =>
  ...
  patientViewed: (payload: PatientViewedPayload, context?: DomainEventContext): DomainEvent =>
  ...
  patientAllergyAdded: (payload: PatientResourcePayload, context?: DomainEventContext) =>
    patientEvent(PatientEventType.PatientAllergyAdded, payload, context),

  patientPreferenceUpdated: (payload: PatientResourcePayload, context?: DomainEventContext) =>
