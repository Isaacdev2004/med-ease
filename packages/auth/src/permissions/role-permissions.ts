...
export const ROLE_HIERARCHY: IdentityRole[] = [
  'platform_admin',
  'facility_admin',
  'physician',
  'pharmacist',
...
export const ROLE_PERMISSIONS: Record<IdentityRole, Permission[]> = {
  platform_admin: [
    'patients.read',
    'patients.write',
    'patients.delete',
...
export function getPermissionsForRole(role: IdentityRole): Permission[] {
